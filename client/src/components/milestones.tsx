    ...
    if (isIntersecting && !animated) {
      ...
      const telegramTimer = setInterval(() => {
        ...
        setDisplayValues((prev) => ({
          ...prev,
          telegram: Math.floor(telegramCurrent),
        }));
      }, 16);
      ...
      const twitterTimer = setInterval(() => {
        ...
        setDisplayValues((prev) => ({
          ...prev,
          twitter: Math.floor(twitterCurrent),
        }));
      }, 16);
      ...
      const marketCapTimer = setInterval(() => {
        ...
        setDisplayValues((prev) => ({
          ...prev,
          marketCap: Math.floor(marketCapCurrent),
        }));
      }, 16);
    }
  ...
  return (
    <section id="milestones" className="py-16 px-6 bg-muted/30" ref={ref}>
      <div className="max-w-7xl mx-auto">
        <h2
          className="text-4xl md:text-5xl font-black text-center mb-16 gradient-text"
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {/* Telegram Users */}
          <Card
            className="border border-border hover:border-primary/50 transition-all duration-300 hover:scale-105 group"
            data-testid="card-milestone-telegram"
          >
          ...
          <Card
            className="border border-border hover:border-primary/50 transition-all duration-300 hover:scale-105 group"
            data-testid="card-milestone-twitter"
          >
            <CardContent className="p-8 text-center">
          ...
          <Card
            className="border border-border hover:border-primary/50 transition-all duration-300 hover:scale-105 group"
            data-testid="card-milestone-marketcap"
          >
            <CardContent className="p-8 text-center">
